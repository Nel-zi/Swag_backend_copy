...
const QRCodeLogin = ({ onBack }) => {
  return (
    <div className="bg-[#292c35] rounded-3xl w-full h-full max-w-md mx-auto flex flex-col items-center relative">
      <button
        className="absolute top-4 left-4 text-2xl text-[#94ffbf] hover:text-[#6ee7b7] bg-black border-none rounded-lg cursor-pointer flex items-center justify-center"
        onClick={onBack}
        aria-label="Back"
        type="button"
      ...
      <div className="w-full flex items-center justify-center relative mb-4">
        ...
        <button
          className="absolute right-0 top-4 text-2xl text-white hover:text-gray-200 border-none cursor-pointer flex items-center justify-center bg-black rounded-lg"
          aria-label="Close"
          onClick={onBack}
          type="button"
          style={{ width: 32, height: 32, padding: 0 }}
      ...
      <div className="flex items-center justify-center mb-5">
        <div className="border border-gray-500 ">
          <div className="p-20 rounded-xl flex items-center justify-center">
            <img
              src="img/Vector.png"
              alt="QR Code"
