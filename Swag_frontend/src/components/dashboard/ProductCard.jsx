...
const products = [
  ...Array.from({ length: 20 }, (_, i) => ({
    id: i + 1,
    store: "nikestores",
    image: i < 10 ? `img/image-${i + 1}.png` : `img/image-${(i % 10) + 1}.png`,
    title: "Men's Sneakers",
    subtitle: "Sneakers",
    price: "$1,800",
    status: "Live • 25",
    used: "Used | Astroloubi",
  })),
];
    ...
    <div className="bg-[#23232a] rounded-2xl w-full max-w-[224px] flex flex-col relative">
      ...
      <div className="flex justify-center items-center relative">
        <img
          src={product.image}
          alt={product.title}
          className="w-full h-auto sm:h-72 object-contain rounded-2xl bg-white"
        />
        <button
...
const ProductCardList = () => (
  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3 sm:gap-4 md:gap-6 max-h-screen overflow-y-auto px-4">
